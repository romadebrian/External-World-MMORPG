   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            Tab(1).Control(3)=   "txtESkillLvl"
            Tab(1).Control(3).Enabled=   0   'False
            Tab(1).Control(4)=   "txtESkillExp"
            Tab(1).Control(4).Enabled=   0   'False
            Tab(1).Control(5)=   "cmdESkillLoad"
            Tab(1).Control(5).Enabled=   0   'False
            Tab(1).Control(6)=   "txtESkillNum"
            Tab(1).Control(6).Enabled=   0   'False
            Tab(1).Control(7)=   "cmdESkillSave"
            ...
            Tab(2).Control(3)=   "cmdEInvSave"
            Tab(2).Control(3).Enabled=   0   'False
            Tab(2).Control(4)=   "txtEItemQty"
            Tab(2).Control(4).Enabled=   0   'False
            Tab(2).Control(5)=   "txtEItemNum"
            Tab(2).Control(5).Enabled=   0   'False
            Tab(2).Control(6)=   "cmdEInvLoad"
            Tab(2).Control(6).Enabled=   0   'False
            Tab(2).Control(7)=   "txtEInvNum"
            ...
            Tab(3).Control(3)=   "cmdEBankSave"
            Tab(3).Control(4)=   "txtEBItemQty"
            Tab(3).Control(5)=   "txtEBItemNum"
            Tab(3).Control(6)=   "cmdEBankLoad"
            Tab(3).Control(7)=   "txtEBankNum"
