...
frmMenu.lblClass.Visible = False
frmMenu.lblSprite.Visible = False
frmMenu.cmbClass.Visible = False
frmMenu.txtRPass2.Visible = False
frmMenu.picSprite.Visible = False
frmMenu.lblBlank(11).Visible = False
frmMenu.lblGender.Visible = False
frmMenu.optMale.Visible = False
frmMenu.optFemale.Visible = False
frmMenu.lblCAccept.Visible = False
...
frmMenu.lblName.Visible = True
frmMenu.txtCName.Visible = True
frmMenu.lblSprite.Visible = True
frmMenu.lblClass.Visible = True
frmMenu.cmbClass.Visible = True
frmMenu.picSprite.Visible = True
frmMenu.lblGender.Visible = True
frmMenu.optMale.Visible = True
frmMenu.optFemale.Visible = True
frmMenu.lblCAccept.Visible = True
frmMenu.lblRegister.Visible = False
frmMenu.lblRegister1.Visible = False
