...
Begin VB.Form frmEditor_Item 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbSound 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":33BC
         Left            =   3720
      ...
      Begin VB.ComboBox cmbBind 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":33C0
         Left            =   4200
         List            =   "frmEditor_Item.frx":33CD
         Style           =   2  'Dropdown List
         TabIndex        =   24
         Top             =   600
         Width           =   1935
      ...
      Begin VB.ComboBox cmbType 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":33F6
         Left            =   120
         List            =   "frmEditor_Item.frx":3418
         Style           =   2  'Dropdown List
         TabIndex        =   21
         Top             =   1200
         Width           =   2655
   ...
   Begin VB.Frame fraEquipment 
      ...
      Begin VB.ComboBox cmbTool 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":3466
         Left            =   1320
         List            =   "frmEditor_Item.frx":3476
         Style           =   2  'Dropdown List
         TabIndex        =   34
         Top             =   360
         Width           =   4815
