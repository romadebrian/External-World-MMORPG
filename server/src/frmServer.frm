...
Private Sub txtChat_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If OptWhite = True Then
            Call GlobalMsg(txtSendBy.Text & ": " & txtChat.Text, White)
            Call TextAdd("Server: " & "(" & txtSendBy.Text & ")" & txtChat.Text)
        ElseIf OptRed = True Then
            Call GlobalMsg(txtSendBy.Text & ": " & txtChat.Text, BrightRed)
            Call TextAdd("Server: " & "(" & txtSendBy.Text & ")" & txtChat.Text)
        ElseIf OptBlue = True Then
            Call GlobalMsg(txtSendBy.Text & ": " & txtChat.Text, BrightBlue)
            Call TextAdd("Server: " & "(" & txtSendBy.Text & ")" & txtChat.Text)
        ElseIf OptGreen = True Then
            Call GlobalMsg(txtSendBy.Text & ": " & txtChat.Text, Green)
            Call TextAdd("Server: " & "(" & txtSendBy.Text & ")" & txtChat.Text)
        Else
            Call GlobalMsg(txtSendBy.Text & ": " & txtChat.Text, White)
            Call TextAdd("Server: " & "(" & txtSendBy.Text & ")" & txtChat.Text)
